...
/** @type {string} */
const CACHE_VERSION = '1762824387|2004309278';
/** @type {string} */
const CACHE_PREFIX = 'Sudoku-sw-cache-';
const CACHE_NAME = CACHE_PREFIX + CACHE_VERSION;
/** @type {string} */
const OFFLINE_URL = 'Sudoku.offline.html';
/** @type {boolean} */
const ENSURE_CROSSORIGIN_ISOLATION_HEADERS = true;
// Files that will be cached on load.
/** @type {string[]} */
const CACHED_FILES = ["Sudoku.html","Sudoku.js","Sudoku.offline.html","Sudoku.icon.png","Sudoku.apple-touch-icon.png","Sudoku.audio.worklet.js","Sudoku.audio.position.worklet.js"];
// Files that we might not want the user to preload, and will only be cached on first load.
/** @type {string[]} */
const CACHEABLE_FILES = ["Sudoku.wasm","Sudoku.pck"];
